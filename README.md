This repository uses the [Axelrod-Python](https://github.com/Axelrod-Python/Axelrod) library to simulate Axelrod's first tournament based on the prisoner's dilemma.
